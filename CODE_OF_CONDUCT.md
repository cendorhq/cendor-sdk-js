...
This Code of Conduct applies within all community spaces of this project — issues, pull requests,
discussions, and reviews — and also applies when an individual is officially representing the project
in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainers **confidentially through GitHub Private Vulnerability Reporting**:

> https://github.com/cendorhq/cendor-sdk-js/security/advisories/new

(the repository's **Security** tab → **Report a vulnerability**), which opens a private report only
the maintainers can see. All complaints will be reviewed and investigated promptly and fairly.
